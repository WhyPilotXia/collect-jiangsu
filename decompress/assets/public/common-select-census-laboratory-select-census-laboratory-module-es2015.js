...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SelectCensusLaboratoryModule", function() { return SelectCensusLaboratoryModule; });
...
/* harmony import */ var _select_census_laboratory_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./select-census-laboratory.page */ "./src/app/common/select-census-laboratory/select-census-laboratory.page.ts");
...
let SelectCensusLaboratoryModule = class SelectCensusLaboratoryModule {
};
SelectCensusLaboratoryModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild([{ path: '', component: _select_census_laboratory_page__WEBPACK_IMPORTED_MODULE_9__["SelectCensusLaboratoryPage"] }])
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SelectCensusLaboratoryPage", function() { return SelectCensusLaboratoryPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
let SelectCensusLaboratoryPage = class SelectCensusLaboratoryPage {
    constructor(router, navCtrl, http, route, platform) {
        this.router = router;
        ...
        this.dtPullToRefreshStyle = { height: this.refreshState.height + 'px' };
        // 控制app返回按钮
    ...
    selectCheackRegister(value, item) {
        const str = 'selectLaboratory' + value;
        const radio = document.getElementsByClassName(str)[0];
        // 清除所有背景
        for (let z = 0; z < this.laboratoryList.length; z++) {
            const radioRem = document.getElementsByClassName('selectLaboratory' + z)[0];
    ...
    doRefresh(event) {
        if (event === 'up') {
            if (this.page < 9) {
                ...
                setTimeout(() => {
                    this.refreshState.refreshState.currentState = 'finish';
                }, 1000);
            }
        }
    }
    ...
    searchRealTime(KeyEvent) {
        ...
        let isSearch = false;
        if (txtAdd.length > 0) {
            const tmpAdd = txtAdd.substring(txtAdd.length - 1);
            const numTmpCHN = this.GetCHNum(tmpAdd);
            if (numTmpCHN > 0) {
                isSearch = true;
            }
        }
    ...
    // 调用后台接口
    // 获取市下面的实验室医院列表
    getLaboratoryList(laboratoryname) {
        this.laboratoryList = [];
        ...
        this.http
            .getNotHeardPost(`rcp/register/sysuser/laboratory`, cond, '获取市下面的实验室医院列表', '获取市下面的实验室医院列表失败')
            .subscribe(data => {
            this.load['style']['display'] = 'none';
            if (data['isSuccess']) {
                this.laboratoryList = data['data'];
                if (data['data'].length > this.laboratoryALLList.length) {
                    this.laboratoryALLList = data['data'];
                }
            }
        });
    }
...
SelectCensusLaboratoryPage.ctorParameters = () => [
...
SelectCensusLaboratoryPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-select-census-laboratory',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./select-census-laboratory.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/common/select-census-laboratory/select-census-laboratory.page.html")).default,
        animations: [
            _shared__WEBPACK_IMPORTED_MODULE_4__["routeAnimation"]
        ],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./select-census-laboratory.page.scss */ "./src/app/common/select-census-laboratory/select-census-laboratory.page.scss")).default]
    })
...
//# sourceMappingURL=common-select-census-laboratory-select-census-laboratory-module-es2015.js.map