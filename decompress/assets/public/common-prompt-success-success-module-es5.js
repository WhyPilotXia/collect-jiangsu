(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common-prompt-success-success-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppCommonPromptSuccessSuccessPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppCommonPromptSuccessSuccessModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SuccessModule", function () {
      ...
      var _success_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./success.page */
      "./src/app/common/prompt/success/success.page.ts");

      var SuccessModule = function SuccessModule() {
        _classCallCheck(this, SuccessModule);
      };

      SuccessModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        imports: [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonicModule"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], ng_zorro_antd_mobile__WEBPACK_IMPORTED_MODULE_6__["NgZorroAntdMobileModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild([{
          path: '',
          component: _success_page__WEBPACK_IMPORTED_MODULE_9__["SuccessPage"]
        }])],
    ...
    /***/
    function srcAppCommonPromptSuccessSuccessPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppCommonPromptSuccessSuccessPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var SuccessPage = /*#__PURE__*/function () {
        function SuccessPage(router, navCtrl, route, platform) {
          var _this = this;
          ...
          this.route = route;
          this.platform = platform; // 控制app返回按钮
        ...
        _createClass(SuccessPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.queryParams.subscribe(function (data) {
              _this2.ContentId = data.ContentId;
              _this2.Barcode = data.Barcode;

              switch (_this2.ContentId) {
                case '1':
                  _this2.message = _this2.Barcode + '箱已成功封箱';
                  _this2.title = '封箱成功';
                  _this2.btnCon = '继续扫描新的箱码';
                  break;

                case '2':
                  _this2.message = _this2.Barcode + '管已成功封管';
                  _this2.title = '封管成功';
                  _this2.btnCon = '继续扫描新的预置码';
                  break;
              }
            });
          }
      ...
      SuccessPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        "./node_modules/raw-loader/dist/cjs.js!./src/app/common/prompt/success/success.page.html"))["default"],
        animations: [_shared__WEBPACK_IMPORTED_MODULE_4__["routeAnimation"]],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./success.page.scss */
        "./src/app/common/prompt/success/success.page.scss"))["default"]]
      })], SuccessPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=common-prompt-success-success-module-es5.js.map