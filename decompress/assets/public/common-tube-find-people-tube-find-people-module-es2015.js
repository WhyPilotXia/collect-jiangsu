...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TubeFindPeopleModule", function() { return TubeFindPeopleModule; });
...
/* harmony import */ var _tube_find_people_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./tube-find-people.page */ "./src/app/common/tube-find-people/tube-find-people.page.ts");
...
let TubeFindPeopleModule = class TubeFindPeopleModule {
};
TubeFindPeopleModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild([{ path: '', component: _tube_find_people_page__WEBPACK_IMPORTED_MODULE_9__["TubeFindPeoplePage"] }])
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TubeFindPeoplePage", function() { return TubeFindPeoplePage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
let TubeFindPeoplePage = class TubeFindPeoplePage {
    constructor(router, navCtrl, http, platform, deleteModal) {
        this.router = router;
    ...
    ListBoxTube(barcode) {
        ...
        this.http
            .get(`rcp/api/tube/operate/QueryTubePatientInfo`, condition, '查询采集管中的患者', '查询采集管中的患者', { load: true })
            .subscribe(data => {
            if (data['isSuccess']) {
                this.personList = data['data']['queryPatientInfoVOList'] === null ? [] : data['data']['queryPatientInfoVOList'];
                this.boxInfo = data['data']['queryTubeInfoVO'];
                console.warn('查询采集管中的患者', this.personList);
            }
        });
    }
};
TubeFindPeoplePage.ctorParameters = () => [
...
TubeFindPeoplePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-tube-find-people',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./tube-find-people.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/common/tube-find-people/tube-find-people.page.html")).default,
        animations: [
            _shared__WEBPACK_IMPORTED_MODULE_4__["routeAnimation"]
        ],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./tube-find-people.page.scss */ "./src/app/common/tube-find-people/tube-find-people.page.scss")).default]
    })
], TubeFindPeoplePage);
...
//# sourceMappingURL=common-tube-find-people-tube-find-people-module-es2015.js.map