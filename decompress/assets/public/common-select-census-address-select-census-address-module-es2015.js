...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SelectCensusAddressModule", function() { return SelectCensusAddressModule; });
...
/* harmony import */ var _select_census_address_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./select-census-address.page */ "./src/app/common/select-census-address/select-census-address.page.ts");
...
let SelectCensusAddressModule = class SelectCensusAddressModule {
};
SelectCensusAddressModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild([{ path: '', component: _select_census_address_page__WEBPACK_IMPORTED_MODULE_9__["SelectCensusAddressPage"] }])
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SelectCensusAddressPage", function() { return SelectCensusAddressPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
let SelectCensusAddressPage = class SelectCensusAddressPage {
    ...
    selectCheackRegister(value, item) {
        const str = 'selectAddress' + value;
        const radio = document.getElementsByClassName(str)[0];
        // 清除所有对号
        for (let z = 0; z < this.addressList.length; z++) {
            const radioRem = document.getElementsByClassName('selectAddress' + z)[0];
            radioRem.className = this.removeClass(radioRem, 'selectAddresShow');
        }
        // 显示当前对号
        radio.className = radio.className + ' selectAddresShow';
        this.address = (item.area == null || item.area == '' ? '' : item.area + '-') +
            (item.street == null || item.street == '' ? '' : item.street + '-') + item.address;
    ...
    searchRealTime(KeyEvent) {
        ...
        if (this.addressAllList !== undefined && this.addressAllList.length > 0) {
            for (const keyAddr of this.addressAllList) {
    ...
    censusaddress(condition) {
        ...
        this.http
            .post(`rcp/api/censusaddress/select`, condition, '获取采集点', _environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].FailMessage.getCensusAddress)
            .subscribe(data => {
...
SelectCensusAddressPage.ctorParameters = () => [
...
SelectCensusAddressPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-select-census-address',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./select-census-address.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/common/select-census-address/select-census-address.page.html")).default,
        animations: [
            _shared__WEBPACK_IMPORTED_MODULE_4__["routeAnimation"]
        ],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./select-census-address.page.scss */ "./src/app/common/select-census-address/select-census-address.page.scss")).default]
    })
...
//# sourceMappingURL=common-select-census-address-select-census-address-module-es2015.js.map