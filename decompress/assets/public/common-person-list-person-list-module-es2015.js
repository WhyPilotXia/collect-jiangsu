...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PersonListModule", function() { return PersonListModule; });
...
/* harmony import */ var _person_list_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./person-list.page */ "./src/app/common/person-list/person-list.page.ts");
...
let PersonListModule = class PersonListModule {
};
PersonListModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild([{ path: '', component: _person_list_page__WEBPACK_IMPORTED_MODULE_8__["PersonListPage"] }])
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PersonListPage", function() { return PersonListPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var id_card_reader__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! id-card-reader */ "./node_modules/id-card-reader/dist/esm/index.js");
/* harmony import */ var scanner__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! scanner */ "./node_modules/scanner/dist/esm/index.js");
...
let PersonListPage = class PersonListPage {
    constructor(router, navCtrl, http, route, platform, deleteModal) {
        this.router = router;
    ...
    ngOnInit() {
        this.route.queryParams.subscribe(data => {
            this.load = document.getElementsByClassName('person-load-bar')[0];
    ...
    ionViewWillEnter() {
        this.titleInfo = sessionStorage.getItem('tubeBarcode');
        // 模式
    ...
    scanIdentity() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const condition = this.getScanCondition('');
            // 未注册, 跳转填写页面
            condition['memo'] = '本人';
            condition['titleId'] = '1';
            this.routeFont(condition);
    ...
    GetPatientTube() {
        ...
        this.http
            ...
            if (data['isSuccess']) {
                ...
                this.personListLength = this.personList.length;
            }
        });
    }
    // 删除采集管
    ...
    deleteTube() {
        ...
        this.http
            .post(`rcp/api/delete/tube/patient` + this.http.getParamsString(condition), {}, '删除采集患者', _environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].FailMessage.deleteSample)
            .subscribe(data => {
    ...
    assignmentValue(condition, item) {
        // 身份信息
...
PersonListPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-person-list',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./person-list.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/common/person-list/person-list.page.html")).default,
        animations: [
            _shared__WEBPACK_IMPORTED_MODULE_4__["routeAnimation"]
        ],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./person-list.page.scss */ "./src/app/common/person-list/person-list.page.scss")).default]
    })
], PersonListPage);
...
//# sourceMappingURL=common-person-list-person-list-module-es2015.js.map