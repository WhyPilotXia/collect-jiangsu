(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["register-register-module"], {
    ...
    function srcAppRegisterRegisterModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _register_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./register.page */
      ...
      RegisterModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
    ...
    function srcAppRegisterRegisterPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ocr__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ocr */
      "./node_modules/ocr/dist/esm/index.js");
      /* harmony import */
      ...
      var Ocr = _capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Plugins"].Ocr;

      var RegisterPage = /*#__PURE__*/function () {
        function RegisterPage(router, navCtrl, http, route, ref, platform, deleteModal, sanitizer, device) {
          var _this = this;
        ...
        _createClass(RegisterPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.queryParams.subscribe(function (data) {
              ...
              if (Object(codelyzer_util_isNotNullOrUndefined__WEBPACK_IMPORTED_MODULE_6__["isNotNullOrUndefined"])(data.patientInfo)) {
                _this2.patientInfo = JSON.parse(data.patientInfo);
                _this2.imageData = sessionStorage.getItem('registerFullStr');
              }
            });
            this.isReplaceProvince = false;
            this.isReplaceCity = false;
          ...
          value: function ionViewWillEnter() {
            ...
            setTimeout(function () {
              if (_this3.titleId === '1') {
                _this3.titleInfo = '注册';
                _this3.titleInfo1 = '扫描您的身份证并填写手机号';
                _this3.titleInfo2 = '填写您所在医院/机构的信息';
              } else {
                _this3.titleInfo = '修改用户信息';
                _this3.titleInfo1 = '扫描您的身份证并核对手机号';
                _this3.titleInfo2 = '修改您所在医院/机构的信息';
              }
            }, 100);
          ...
          key: "changAreaId",
          value: function changAreaId(value) {
            this.getStreet(value);
          }
        }, {
          key: "changeStreet",
          value: function changeStreet(value) {
          ...
          key: "getKey",
          value: function getKey(condition) {
            var _this4 = this;
            ...
            this.http.getNotHeard("rcp/open/api/key?_allow_anonymous=true").subscribe(function (data) {
              if (data['code'] === '0') {
                ...
                condition['uuid'] = _this4.uuid === null ? null : _this4.primeArr[_this4.getRan(0, 9)] + _this4.uuid + _this4.primeArr[_this4.getRan(0, 9)];

                _this4.saveRegister(condition);
              } else {
                _this4.http.showFail(data, '加密信息失败！');
              }
            });
          } // 1. 采集员注册
          ...
          key: "saveRegister",
          value: function saveRegister(condition) {
            var _this5 = this;

            this.http.getNotHeardPost("rcp/register/sysuser/register", condition, '采集员注册', 'false', {
              load: true
            }).subscribe(function (data) {
              if (data['code'] === '0') {
                _this5.http.showToast('注册成功');

                _this5.routeBack();
              } else {
                _this5.deleteModal.alert('注册失败提示', data['message'], [{
                  text: '确定',
          ...
          value: function getRegisterInfo() {
            ...
            this.http.getNotHeardPost("rcp/register/sysuser/detail" + this.http.getParamsString({
              idenno: this.patientInfo.identity
            }), {}, '通过身份证号，获取用户信息', '通过身份证号，获取用户信息失败', {
              load: true
            }).subscribe(function (data) {
              if (data['isSuccess']) {
                _this6.patientInfo = {
                  ...
                  verifyCode: _this6.patientInfo.verifyCode
                };
                _this6.selectPersonnelType = data['data']['classify'] === null ? '医院护士' : data['data']['classify'];
                _this6.step = '2';
                _this6.isReplaceProvince = false;
                _this6.isReplaceCity = false;

                _this6.getCity(_this6.patientInfo.provinceId);
              }
            });
          } // 修改采集员注册
          ...
          key: "updateRegister",
          value: function updateRegister(condition) {
            var _this7 = this;

            this.http.getNotHeardPost("rcp/register/sysuser/register/update", condition, '修改采集员注册信息', '修改采集员注册信息失败', {
              load: true
            }).subscribe(function (data) {
              if (data['isSuccess']) {
                _this7.http.showToast('修改成功');
          ...
          value: function getProvince() {
            ...
            this.ProvinceList = [];
            this.http.getNotHeardPost("rcp/register/sysuser/province", {}, '获取省列表', '获取省失败', {
              load: true
            }).subscribe(function (data) {
              if (data['isSuccess']) {
                _this8.ProvinceList = data['data'];

                if (!_this8.isReplaceProvince) {
                  _this8.getCity(_this8.patientInfo.provinceId);
                }
              }
            });
          } // 获取市
          ...
          value: function getCity(cond) {
            ...
            this.http.getNotHeardPost("rcp/register/sysuser/city" + this.http.getParamsString({
              provinceId: cond
            }), {}, '获取市列表', '获取市失败', {
              load: true
            }).subscribe(function (data) {
              if (data['isSuccess']) {
                _this9.cityList = data['data'];

                if (!_this9.isReplaceCity) {
                  _this9.getArea(_this9.patientInfo.cityId);
                }
          ...
          value: function getArea(cond) {
            ...
            this.http.getNotHeardPost("rcp/register/sysuser/area" + this.http.getParamsString({
              cityId: cond
            }), {}, '获取区列表', '获取区失败', {
              load: true
            }).subscribe(function (data) {
              if (data['isSuccess']) {
                _this10.areaList = data['data'];
          ...
          key: "getStreet",
          value: function getStreet(cond) {
            var _this11 = this;

            this.streetList = [];
            this.patientInfo.laboratoryId = undefined;
            this.patientInfo.hospital = undefined;
            this.http.getNotHeard("rcp/open/api/getCountryList" + this.http.getParamsString({
              areaId: cond
            })).subscribe(function (data) {
              if (data['code'] === '0') {
                _this11.streetList = data['data'];

                _this11.ionViewWillEnter();
              }
            });
          } // 获取社区
          ...
          key: "getCommunity",
          value: function getCommunity(cond) {
            var _this12 = this;

            this.communityList = [];
            this.patientInfo.hospital = undefined;
            this.http.getNotHeard("rcp/open/api/getCommunityList" + this.http.getParamsString({
              countryId: cond
            })).subscribe(function (data) {
              if (data['code'] === '0') {
                _this12.communityList = data['data'];

                _this12.ionViewWillEnter();
              }
            });
          } // 获取验证码
          ...
          value: function getVerifyCode() {
            ...
            this.http.getNotHeardBlob("rcp/open/api/verifyCode?uuid=" + (this.uuid === null ? null : this.primeArr[this.getRan(0, 9)] + this.uuid + this.primeArr[this.getRan(0, 9)])).subscribe(function (data) {
              _this13.verifyCodeJpg = _this13.sanitizer.bypassSecurityTrustUrl(window.URL.createObjectURL(data.body));
              _this13.verifyCode = data.headers.get('verifyCode');
            });
          } // 校验手机号

        }, {
          key: "checkPhoneSave",
          value: function checkPhoneSave() {
            var _this14 = this;
            ...
            if (this.titleId === '2') {
              ...
              this.http.getNotHeard("rcp/register/sysuser/registerCheckMobile" + this.http.getParamsString({
                mobile: this.patientInfo.mobile,
                uuid: this.uuid === null ? null : this.primeArr[this.getRan(0, 9)] + this.uuid + this.primeArr[this.getRan(0, 9)]
              })).subscribe(function (data) {
                console.log('#########', data);
                ...
                if (data['code'] === '0') {
                  ...
                  _this14.http.showToast(data['message']);
                }
              });
            }
          } // 扫描身份证
          ...
          value: function dealScanResult() {
            ...
            if (this.titleId === '2') {// 修改注册信息--通过身份证号获取信息
              //  this.getRegisterInfo();
            }
      ...
      RegisterPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        animations: [_shared__WEBPACK_IMPORTED_MODULE_8__["routeAnimation"]],
